...
export const createdForm = createAction('[Form Builder] Form created', props<{ form: FormConfig }>());
export const updateForm = createAction('[Form Builder] Update the form', props<{ form: FormConfig }>());
